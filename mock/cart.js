export default {
  "GET /api/grd/cart_list": (req, res) => {
    return res.json({
      uid: "123",
      cid: "123",
      selectList: ["590240548641", "590238976728"],
      itemList: [
        {
          gid: "590240548641",
          uid: "33636250",
  ...
  "POST /api/grd/add_cart": (req, res) => {
    return res.json({
      status: "success",
      code: "200"
    });
  },
  "POST /api/grd/update_cart": (req, res) => {
    return res.json({
      status: "success",
      code: "200"
    });
  },
  "POST /api/grd/delete_cart": (req, res) => {
    return res.json({
      status: "success",
      code: "200"
    });
